...
def write_lammps(ele, func, nrho, nr, dr, drmax, com1, com2, header=0):
...
def vhh_densityhh_ram(r, afn, r_cut_hh=2.3, c1=0.0, c2=0.0):
    a0 = 0.52917721092
    rhoH = [0] * len(r)
    FH = [0] * len(r)
    phi_hh = [0] * len(r)
...
def vhh_densityhh_ram_song(r, afn, r_cut_hh=2.3, c1=0.0, c2=0.0,
...
aphik_pota = [14.0786236789212005, -4.4526835887173704,  5.5025121262565992,
              -1.0687489808214079, -0.3461498208163201,
              -0.0064991947759021, -0.0357435602984102]
rphik_pota = [1.6, 1.7, 1.8, 2.0, 2.5, 3.2, 4.2]
arhok_feh_pota = [
    10.0073629216300581, 32.4861983261490295, -0.9494226032063788,
    11.6659812262450338, -0.0147080251458273, 0.4943383753319843]
rrhok_feh_pota = [1.6, 1.8, 2.0, 2.4, 3.2, 4.2]
arhok_hfe_pota = [11.1667357634216433, -3.0351307365078730,
                  3.6096144794370653, 0.0212509034775648, 0.0303914939946250]
rrhok_hfe_pota = [1.5, 2.0, 2.5, 3.0, 4.2]
r1_pota, r2_pota = 0.6, 1.2
Bn_pota = [1242.1709168218642, -6013.566711223783, 12339.540893927151,
...
pairwise_e = pairwise_e(Z1=Zfe, Z2=Zh, r1=r1_pota, r2=r2_pota,
                        aphik=aphik_pota, rphik=rphik_pota, Bn=Bn_pota)
embed_d_feh = embed_d(arhok=arhok_feh_pota, rrhok=rrhok_feh_pota)
embed_d_hfe = embed_d(arhok=arhok_hfe_pota, rrhok=rrhok_hfe_pota)

embed_density_fefe = Fe_Mendelev_pot4.embed_density
embed_energy_fefe = Fe_Mendelev_pot4.embed_energy
pair_pot_fefe_lammps = Fe_Mendelev_pot4.pair_pot_lammps
pair_pot_fefe = Fe_Mendelev_pot4.pair_pot
...
#     vhh_densityhh_ram(r, afn_pota, r_cut_hh=2.3)

# +-+-+-+ +-+-+-+-+-+-+ +-+-+-+-+-+-+
# |u|s|e| |s|o|n|g|'|s| |r|e|v|i|s|e|
# +-+-+-+ +-+-+-+-+-+-+ +-+-+-+-+-+-+
pair_pot_hh, pair_pot_hh_lammps, embed_density_hh =\
    vhh_densityhh_ram_song(r, afn_pota, r_cut_hh=2.3)

embed_energy_hh = embed_energy_hh_ram(rho, afn_pota)
...
pot_name = 'Ram_potA_song'
com1 = '26 5.5847000000000E+0001 2.8557E+0000 BCC'
com2 = '1 1.008 1.8 BCC'
ele = ['Fe', 'H']
...
if __name__ == "__main__":
    ...
    write_lammps(ele, embed_energy_fefe, nrho,
                 nr, dr, drmax, com1, com2, header=1)
    # strat from 2007
    write_lammps(ele, embed_density_fefe, nrho, nr, dr, drmax, com1, com2)
    # strat from 4007
    write_lammps(ele, embed_density_feh, nrho, nr, dr, drmax, com1, com2)
    # strat from 6008
    write_lammps(ele, embed_energy_hh, nrho,
                 nr, dr, drmax, com1, com2, header=2)
    # strat from 8008
    write_lammps(ele, embed_density_hfe, nrho, nr, dr, drmax, com1, com2)
    # strat from 10008
    write_lammps(ele, embed_density_hh, nrho, nr, dr, drmax, com1, com2)
    # strat from 12008
    write_lammps(ele, pair_pot_fefe_lammps, nrho, nr, dr, drmax, com1, com2)
    # strat from 14008
    write_lammps(ele, pair_pot_feh_lammps, nrho, nr, dr, drmax, com1, com2)
    # strat from 16008
    write_lammps(ele, pair_pot_hh_lammps, nrho, nr, dr, drmax, com1, com2)
    # +-+-+-+-+-+-+-+-+-+
    # |w|r|i|t|e|_|p|l|t|
    # +-+-+-+-+-+-+-+-+-+
