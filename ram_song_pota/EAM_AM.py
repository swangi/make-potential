...
class pairwise_e:
    ...
    def __init__(self, Z1=26, Z2=26, Zcoeff=14.399644447372927, r1=0, r2=0,
                 aphik=None, rphik=None, Bn=None, **kwargs):
        self.Z1 = Z1
        self.Z2 = Z2
        self.Zcoeff = Zcoeff
        self.r1 = r1
...
class embed_e:
    ...
    def __init__(self, ap=-0.00035387096579929):
        self.ap = ap

    def F(self, rho):
        V = -rho ** 0.5 + self.ap * rho ** 2
        return V
...
class embed_d:
    ...
    def __init__(self, arhok=None, rrhok=None):
        self.arhok = arhok
        self.rrhok = rrhok
